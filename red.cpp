...
Red::Red(char* pRuta, char eleccionAlgoritmo){
    ...
    cout << "creo el objeto Red que ocupa " << sizeof(Red) << " bytes en la dirección " << (unsigned)this;
}
...
Red::~Red(){
    ...
    cout << "borro el objeto Enlace que ocupa " << sizeof(Enlace) << " bytes en la dirección " << (unsigned)this;
    delete listaEnlaces;
    ...
    cout << "borro el objeto Central que ocupa " << sizeof(Central) << " bytes en la dirección " << (unsigned)this;
    delete listaCentrales;
    cout << "borro el objeto caminoMinimo que ocupa " << sizeof(caminoMinimo) << " bytes en la dirección " << (unsigned)this;
    delete caminoMinimo;
}
...
Lista<unsigned int>* Red::obtenerCamino(Lista<Lista4<Central*>*>* niveles, Central* cDestino){
    ...
    cout << "borro el objeto camino que ocupa " << sizeof(camino) << " bytes en la dirección " << (unsigned)this;
    ...
    while (niveles->avanzarCursor()){
        ...
        while (nivel->avanzarCursor()){
            ...
            if (vertice->obtenerCentral() == cDestino &&
                ...
                vertices->agregar(0,0, vertice->obtenerCentral(), vertice->obtenerAdyacente(),0,0);
                verticeAnterior = vertice->obtenerSiguiente();
            }
        }
