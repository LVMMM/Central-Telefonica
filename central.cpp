...
Central::Central(unsigned int nuevoId){
    ...
    cout << "creo el objeto Central que ocupa " << sizeof(Central) << " bytes en la dirección " << (unsigned)this;
...
Central::~Central(){
    ...
    cout << "borro el objeto Central que ocupa " << sizeof(EnlaceACentral) << " bytes en la dirección " << (unsigned)this;
    ...
    cout << "creo el objeto Interno que ocupa " << sizeof(Interno) << " bytes en la dirección " << (unsigned)this;
